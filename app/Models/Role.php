...
class Role extends Model
{
    ...
    {
        return [
            self::ADMIN => ['dashboard', 'building-permits', 'building-types', 'building-categories', 'permit-approvals', 'reports', 'users'],
            self::ADMINISTRATOR => ['dashboard', 'building-permits', 'building-types', 'building-categories', 'permit-approvals', 'reports', 'users'],
